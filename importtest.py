...
import lumapi
import LumOptPrivate

# Optimization specific imports
from LumOptPrivate import CONFIG
from LumOptPrivate.geometries.topology import TopologyOptimization2D
from LumOptPrivate.utilities.load_lumerical_scripts import load_from_lsf
from LumOptPrivate.figures_of_merit.modematch import ModeMatch
from LumOptPrivate.optimization import Optimization
from LumOptPrivate.optimizers.generic_optimizers import ScipyOptimizers
from LumOptPrivate.utilities.wavelengths import Wavelengths
...
if __name__ == '__main__':
    ...
    eps_wg = 2.8**2
    eps_bg = 1.44**2 # the refractive indices?
    x_pos = np.linspace(-size_x/2*1e-9,size_x/2*1e-9,x_points) # I think this is the initial points of the shape under construction
